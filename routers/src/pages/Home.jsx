    ...
    return(
        <div className="home-container" data-aos="fade-up">
            <div className="profile-container">
                ...
                <div className="profile-img" onClick={Image_rotate} style={{transform: `rotate(${rotate}deg)`}}>
                    <img  className="" src="./Images/profile.JPG" alt="" />
                </div>
                <div className="typer-section">
                    <h1> I'm a </h1>
                    <h1 className="typer" style={{ color: colors[wordIndex]}}>{displayedText}<span className="cursor">|</span></h1>
                </div>    
            </div>
            ...
            <div className="skills-section" data-aos="fade-up">
                ...
                <ul className="skills-list">
                    ...
                    <li><img src="./Images/css-3.png" alt="" /></li>
